...
export const MyAccount=()=>{
    ...
    <div className="grid grid-cols-4 gap-5 bg-white text-black pb-12 mt-32 pr-8 pl-8 pt-10">
        <AccountOption title={"Sécurité & confidentialité"} icon={"fa-solid fa-lock"} text={"Changer mot de passe, supprimer compte"} link={`/${document.cookie}/my-account/Sécurité&confidentialité`} />
    ...
    <div className="flex justify-center">
        <button className="bg-white text-red-600 mt-16 pl-7 pr-7 mb-24" style={{boxShadow:"0 4px 10px rgba(0, 0, 0, 0.2)"}} onClick={()=>{document.cookie=`c=;expires=Thu, 01 Jan 1970 00:00:00 UTC;path:/;`;window.location.replace('/')}}>Se deconnecter</button>
    </div>
    <Footer/>
    </>)
}