        ...
        <>{data.length>6?<div className="flex h-full bg-gray-100">
            <aside className="w-1/4 bg-blue-600 text-white p-4">
                ...
                <ul className="space-y-4">
                    ...
                    <li className="bg-white text-black p-2 rounded">Medecins</li>
            ...
            <main className="w-3/4 p-6">
                <div className="flex justify-between items-center mb-6">
                    <h2 className="text-2xl font-bold">Gestion des medecins</h2>
                </div>
                ...
                {loading && <p className="text-blue-600 p-4 text-center">Chargement des medecins...</p>}
                {!loading && data.length === 0 && (
                    <p className="text-red-600 p-4 text-center">Aucun medecin trouvé</p>
                )}
            </main>
