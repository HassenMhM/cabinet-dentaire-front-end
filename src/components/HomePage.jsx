...
export const HomePage=()=>{
    ...
    <div className="flex text-center flex-col text-white mt-56">
        ...
        <button className="text-xl rounded-xl bg-slate-300 text-black mt-5 self-center transition-all duration-300 hover:bg-slate-400  hover:scale-105 " onClick={()=>navigate('/cabinait-dentaire/login')}>Prendre rendez-vous</button>
    </div> 
    </>)
}