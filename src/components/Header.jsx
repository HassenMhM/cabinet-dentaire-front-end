...
export const Header=(props)=>{
    ...
    <div className="flex  justify-evenly mt-7">
        ...
        <div className="flex flex-row">
            ...
            {logedIn==true?<Link to={`/${localStorage.getItem('AuthSecure')}/my-account`} className="mr-3 ml-3 text-white font-extralight text-lg">Mon compte</Link>:<a href="/login"  className="mr-3 ml-3 text-white font-extralight text-lg">Se connecter</a>}
        </div>
    </div>
    </>)
}