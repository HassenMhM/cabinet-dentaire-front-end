...
export const SecuritéPage=()=>{
    ...
    <div className="flex flex-col mt-36 ml-48 mr-48 p-11 justify-center mb-32">
        ...
        <Link className="p-4 hover:cursor-pointer pl-7 mb-3 hover:text-blue-900" to={`/${localStorage.getItem('AuthSecure')}/my-account/Sécurité&confidentialité/ChangePassword`} style={{boxShadow:"0 4px 10px rgba(0, 0, 0, 0.1)"}}>Changer mot de passe</Link>
